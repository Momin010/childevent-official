...
import { Shield, Users, Calendar, BarChart3, Settings, LogOut, Terminal } from 'lucide-react';
...
export const AdminPanel: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'regular' | 'super'>('regular');
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <p className="text-sm mt-2">
            {activeTab === 'super' ? 'SUPER ADMIN MODE - UNRESTRICTED ACCESS' : 'Secure administrative access granted'}
          </p>
        </motion.div>
      </div>
    </div>
